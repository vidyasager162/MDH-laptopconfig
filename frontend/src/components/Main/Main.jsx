...
function Main(props) {
  ...
  function getDepartments() {
    fetch("http://127.0.0.1:8000/get-departments", {
      method: "GET",
      headers: {
  ...
  function getSubjects() {
    fetch("http://127.0.0.1:8000/get-subjects", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function getTeachers() {
    fetch("http://127.0.0.1:8000/get-teachers", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function getStudents() {
    fetch("http://127.0.0.1:8000/get-students", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function getTeacherSchedules() {
    fetch("http://127.0.0.1:8000/get-teacherschedules", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function getStudentSchedules() {
    fetch("http://127.0.0.1:8000/get-studentschedules", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },

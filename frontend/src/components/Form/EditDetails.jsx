...
function EditDetails(props) {
  ...
  function getDepartment() {
    fetch("http://127.0.0.1:8000/get-department", {
      method: "POST",
      headers: {
  ...
  function getCourse() {
    fetch("http://127.0.0.1:8000/get-course", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function getSubject() {
    fetch("http://127.0.0.1:8000/get-subject", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function editSubject(sub_id, event) {
    ...
    fetch("http://127.0.0.1:8000/edit-subject", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function editCourse(course_id, event) {
    ...
    fetch("http://127.0.0.1:8000/edit-course", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function editDepartment(dept_id, event) {
    ...
    fetch("http://127.0.0.1:8000/edit-department", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
